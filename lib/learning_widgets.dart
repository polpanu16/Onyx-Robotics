...
const comparisons = <List<(String, String, String)>>[
  ...
  [
    ('โจทย์', 'สรุปภาษาไทย 6 หน้า', 'นำเสนอภาษาอังกฤษ 9 หน้า พร้อมตัวอย่าง'),
    ('เนื้อหา', 'สรุปแนวคิดและข้อจำกัด', 'ขยายรายละเอียดหุ่นยนต์ในโลกสมมติ'),
    ('ไฟล์ประกอบ', 'PDF จริง Zero-shot 6 หน้า', 'PDF จริง Few-shot 9 หน้า'),
  ],
  [
